...
# 제한 사항
1. 지방의 수는 3 이상 100,000 이하인 자연수입니다.
2. 각 지방에서 요청하는 예산은 1 이상 100,000 이하인 자연수입니다.
3. 총 예산은 지방의 수 이상 1,000,000,000 이하인 자연수입니다.
'''
...
def solution(budgets, M):
    ...
    while _min <= _max:
        mid = (_min + _max) // 2
        reduced_b = sum([b if b < mid else mid for b in budgets])
