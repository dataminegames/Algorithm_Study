...
# 제한사항
1. 격자의 크기 m, n은 1 이상 100 이하인 자연수입니다. m과 n이 모두 1인 경우는 입력으로 주어지지 않습니다.
2. 물에 잠긴 지역은 0개 이상 10개 이하입니다.
3. 집과 학교가 물에 잠긴 경우는 입력으로 주어지지 않습니다.
'''


def solution(m, n, puddles):
    way = [[1]*m for row in range(n)]
